...
final class QqConfig extends ConfigInterface
{
    ...
    // 统一下单url
    const UNIFIED_URL = 'https://qpay.qq.com/cgi-bin/pay/qpay_unified_order.cgi';

    // 提交刷卡支付url
    const MICROPAY_URL = 'https://qpay.qq.com/cgi-bin/pay/qpay_micro_pay.cgi';

    // 支付查询url
    const CHARGE_QUERY_URL = 'https://qpay.qq.com/cgi-bin/pay/qpay_order_query.cgi';

    // 查询退款url
    const REFUDN_QUERY_URL = 'https://qpay.qq.com/cgi-bin/pay/qpay_refund_query.cgi';

    // 申请退款url
    const REFUND_URL = 'https://api.qpay.qq.com/cgi-bin/pay/qpay_refund.cgi';

    // 关闭订单url  尚未接入
    const CLOSE_URL = 'https://qpay.qq.com/cgi-bin/pay/qpay_close_order.cgi';

    // 短连接转化url  尚未接入
    const SHORT_URL = 'https://api.mch.weixin.qq.com/tools/shorturl';

    // 企业付款
    const TRANSFERS_URL = 'https://qpay.qq.com/cgi-bin/pay/qpay_unified_order.cgi';

    // 企业付款的查询
    const TRANS_QUERY_URL = 'https://qpay.qq.com/cgi-bin/pay/qpay_order_query.cgi';
