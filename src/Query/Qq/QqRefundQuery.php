...
use Payment\Common\Qq\Data\Query\RefundQueryData;
...
class QqRefundQuery extends QqBaseStrategy
{
    ...
    {
        return QqConfig::REFUDN_QUERY_URL;// 查询退款url
    }
    ...
    protected function createBackData(array $data)
    {
        ...
        for ($i = 0; $i<$refund_count; $i++) {
            ...
            $refund_id = 'refund_id_' . $i;// QQ钱包退款单号
        ...
        $retData = [
            ...
            'response'  => [
                ...
                'transaction_id'   => $data['transaction_id'],// QQ钱包订单号
